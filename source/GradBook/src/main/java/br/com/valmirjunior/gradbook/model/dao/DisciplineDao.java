...
public class DisciplineDao extends GenericDao {
	...
	public List<Discipline> getListEager() {
		TypedQuery<Discipline> query = super.manager
				.createQuery("select d from Discipline d left join fetch d.semester s left join fetch s.course", Discipline.class);
		return query.getResultList();
	}
